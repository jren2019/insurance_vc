...
def populate_test_data():
    ...
    with app.app_context():
        ...
        try:
            ...
            # Generate some additional verification logs for unknown credentials
            print("🔍 Generating verification logs for unknown credentials...")
            unknown_credentials = [
            ...
            session.commit()
            print("✅ Created verification logs for unknown credentials")
            ...
            print("\nCredential Types:")
            for cred_type, _ in credential_types:
            ...
            avg_response_time = session.query(VerificationLog).with_entities(
                session.query(VerificationLog.response_time).func.avg()
            ).scalar()
