...
echo "   - Frontend: https://issuance-vc.australiaeast.cloudapp.azure.com"
echo "   - Backend API: https://issuance-vc.australiaeast.cloudapp.azure.com/api"
echo "   - Health Check: https://issuance-vc.australiaeast.cloudapp.azure.com/health"
echo ""
