...
echo "   - Frontend: http://issuance-vc.australiaeast.cloudapp.azure.com"
echo "   - Backend API: http://issuance-vc.australiaeast.cloudapp.azure.com/api"
echo "   - Health Check: http://issuance-vc.australiaeast.cloudapp.azure.com/health"
echo ""
